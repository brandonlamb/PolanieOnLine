...
class ReachedAchievements {
	...
	ReachedAchievements() {
		...
		JComponent test = SBoxLayout.createContainer(SBoxLayout.VERTICAL, pad);

		final JLabel selectorLabel = new JLabel("Tryb wykorzystywania karmy w walce XD");
		test.add(selectorLabel);

		page.add(test, SLayout.EXPAND_X);
	}

	/**
	 * Get the component containing reached achievements.
	 *
	 ...
	 */
	private Sprite createAchievements(String title, String description, String category) {
